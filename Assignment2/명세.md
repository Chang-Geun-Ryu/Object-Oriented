...
4. 명함(Business Card)
   ...
   **추가 정보**
   ...
   - 출력 방향: 세로 방향(portrait) 또는 가로 방향(landscape)
   - 종이 색: 회색(#E6E6E6), 아이보리(#FFFFF0), 흰색(#FFFFFF)
   - 고객이 자유로이 문구나 사진을 추가하고 위치를 변경할 수 있음 (출력되는 문구/사진마다 +5의 추가 비용 발생)
...
### 3.2 빨강 잉크 4 x 3 cm 스탬프의 문구 바꾸기

1. 빨강 잉크가 들은 4 x 3 cm 스탬프를 만든다.
2. 스탬프의 문구를 바꾼다
3. 문구가 제대로 바뀌었는지 확인한다.

### 3.3 빨강 잉크 4 x 3 cm 스탬프의 배송 방법 바꾸기

1. 빨강 잉크가 들은 4 x 3 cm 스탬프를 장바구니에 추가한다.
2. 배송 방법을 바꾼다.
3. 빨강 잉크가 들은 4 x 3 cm 스탬프의 배송 방법이 제대로 바뀌었는지 확인한다.

### 3.4 하얀색 20 x 15cm 벽걸이 달력 만들기

1. 하얀색 20 x 15 cm 벽걸이 달력을 만든다.
2. 생성 중에 초기화한 멤버 변수들의 값이 올바른지 확인한다.
3. 가격이 올바른지 확인한다.
4. 올바른 크기가 반환되는지 확인한다.
5. 올바른 색상이 반환되는지 확인한다.

### 3.5 하얀색 20 x 15cm 벽걸이 달력의 배송 방법 바꾸기

1. 하얀색 20 x 15 cm 벽걸이 달력을 장바구니에 추가한다.
2. 배송 방법을 바꾼다.
3. 하얀색 20 x 15 cm 벽걸이 달력의 배송 방법이 제대로 바뀌었는지 확인한다.

### 3.6 1 x 0.5 m 반사 배너 만들기
...
### 3.8 1 x 0.5 m 반사 배너의 배송 방법 바꾸기
...
**그게 아니라** `Foo` 클래스에 있는 `bar()` 메서드가 빨강 잉크 스탬프를 만든다면 다음과 같이 해주세요.
